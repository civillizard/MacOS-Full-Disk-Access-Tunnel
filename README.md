...
- [launchctl, scheduling shell scripts on macOS, and Full Disk Access](https://kith.org/jed/2022/02/15/launchctl-scheduling-shell-scripts-on-macos-and-full-disk-access/) — Kith.org (2022). Covers the launchd + FDA interaction.
